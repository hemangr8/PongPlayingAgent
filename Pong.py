...
# Next transform those either via a ReLU of some sort.
# ReLU(hidden_layer_values)
# Next pass this one layer further
# output_layer_value = weights['2'] dot hidden_layer_values ([1 x 200] dot [200 x 1] -> [1 x 1])
# Now output layer is the probability of going up or down. Let's make sure this output is between 0 and 1 by passing it through a sigmoid
...
def preprocess_observations(input_observation, prev_processed_observation, input_dimensions):
    ...
    # store the previous frame so it can be subtracted from it next time
...
def main():
    ...
    observation = env.reset() # This gets the image
    ...
    while True:
        ...
        if done: # an episode finished
            ...
            # Sum the gradient for use when it hits the batch size
